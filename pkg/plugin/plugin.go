...
// libnetwork/ipams/remote/api. They are declared here rather than
// imported because this plugin talks to the daemon over HTTP and JSON:
// the wire shape is the contract, and importing moby's structs would
// hide a rename behind a compile that still succeeded.
//
...
// outside this module is expected to import it — the supported
// interface to a running plugin is the socket, not this API.
//

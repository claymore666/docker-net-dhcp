...
the plugin does not yet supply the replacement.
...
there is a global address to install it beside, which is
[#818](https://github.com/claymore666/docker-net-dhcp/issues/818) on
this same milestone: it forms the address under the plugin's own
control, and the route and the address arrive together.

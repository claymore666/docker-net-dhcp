...
Both PRs were filed in June 2026 and are awaiting review. Neither issue
here will be closed as "won't fix" while that is the only thing in the
way; the fork's own half of each is written and waiting.
